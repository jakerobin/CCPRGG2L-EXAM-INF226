...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^[^rsldRSLD]{7,}$");
        //surname does not begin with a vowel thus any character is valid at the beginning of the pw
        //surname does not end with a consonant thus any character is valid at the end of the pw
        ...
        pattern = Pattern.compile("^[\\w.*00]{8,}.*[\\w.]*@gmail\\.com$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^(http://|https://)?(www.)?([A-Za-z0-9]+(-[A-Za-z]+)*([kyla]*[rosaldo]*\\.))[A-Za-z]+((/[A-Za-z0-9-._~:/?#\\[\\]@!$&'()*+,;=]+)*/?)?$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(\\w+\\.(?!pptx|xlsx|docx|txt)[\\w]+)");
